...
{
  public:
    using CuteLoggerMessageHandler = bool(*)(Logger::LogLevel, const QString&);
    
    ConsoleAppender();
    virtual QString format() const;
    void ignoreEnvironmentPattern(bool ignore);
    void installCustomLogHandler(CuteLoggerMessageHandler);
  ...
  private:
    ...
    CuteLoggerMessageHandler    m_handlerPFN = nullptr;
};
